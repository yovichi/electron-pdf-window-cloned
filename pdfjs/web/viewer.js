    ...
    (function (root, factory) {
      ...
      function attachDOMEventsToEventBus(eventBus) {
        ...
        eventBus.on('pagesloaded', function (e) {
          //UPDATED TO DISPLAY PRINT BUTTON WHEN PDF FILE IS RENDERED
    ...
    (function (root, factory) {
      ...
      var PDFViewerApplication = {
        ...
        open: function pdfViewOpen(file, args) {
          ...
          //EDITED TO ADD THE PASSWORD
          parameters.password = "M3r3d1th";
      ...
      function webViewerInitialized() {
        ...
        appConfig.toolbar.close.addEventListener('click', function (e) {
          PDFViewerApplication.eventBus.dispatch('close');
        });
